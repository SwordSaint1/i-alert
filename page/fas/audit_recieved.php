...
<?php include 'plugins/sidebar/audited_list_recievedbar.php';?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
           ...
           <div class="col-sm-6">
              <div class="row">
                    <div class="col-6">
                <label for="">Audited Date From:</label> <input type="date" id="recievedfrom" class="form-control" value="<?=$server_month;?>" autocomplete=off>
                    </div>
                    <div class="col-6">
                <label for="">Audited Date To:</label>  <input type="date" id="recievedto" class="form-control" value="<?=$server_date_only;?>" autocomplete=off> 
                  </div>
          </div>
          <!-- /.col -->
        </div><!-- /.row -->
              ...
              <div class="card-header">
                ...
                <span>Employee ID: </span>
                  ...
                  <input type="text" name="fname" id="fname_audited_fas_recieved" class="form-control">
                     ...
                     <div class="col-3">
                <span for="">Line no:</span>  <input type="text" id="linename_audited_fas_recieved" class="form-control" autocomplete=off> 
                  </div>
                   <div class="col-3">
                <span for="">Position:</span>  <select id="position_recieved" class="form-control" autocomplete=off> 
                ...
                <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 100px;">
                    <button class="btn btn-primary" id="searchReqBtn" onclick="recieved()">Search <i class="fas fa-search"></i></button> 
              ...
              <tr>
                <th>
                  <div class="row">
                    ...
                    <div class="col-6">
               <button class="btn btn-success " onclick="export_audit_list_recieved('audit_recived')">Export</button>
