...
<div class="modal fade bd-example-modal-xl" id="sec5" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">
            <div><h3><b>Section 5</b></h3>
               <div class="col-sm-12">
              <div class="row">
                    <div class="col-5">
                <label for="">Audited Date From:</label> <input type="date" id="auditedsec5datefrom" class="form-control" value="<?=$server_month;?>" autocomplete=off>
                    </div>
                    <div class="col-5">
                <label for="">Audited Date To:</label>  <input type="date" id="auditedsec5dateto" class="form-control" value="<?=$server_date_only;?>" autocomplete=off> 
                  </div>
                  <div class="col-2">
                      <div class="card-tools">
                  <div class="input-group input-group-sm" style="width: 100px;">
                    <button class="btn btn-primary" id="searchReqBtn" onclick="load_sec5()">Search <i class="fas fa-search"></i></button> 
                  </div>
                </div>
              </div>
                  </div>
...
<button class="btn btn-info" data-toggle="modal" data-target="#count">Audit&nbsp;Count</button>&nbsp;    <button class="btn btn-danger" onclick="delete_sec5()">Delete</button>                
    </div>
           </div>
      </div>
